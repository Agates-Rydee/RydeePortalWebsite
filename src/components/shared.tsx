  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at center, rgba(23,168,130,0.12) 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at bottom right, rgba(23,168,130,0.08) 0%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
    </>
